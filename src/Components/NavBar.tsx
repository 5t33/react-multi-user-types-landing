      ...
      <AppBar>
        <Toolbar className={classes.ToolBarStyles}>
          <div
            ...
            onClick={() => scrollToDiv(props.topRef)}
          >
            <Typography>Band&nbsp;Connect</Typography>
          </div>
          <div className={classes.HorizontalMenuContainer}>
            <Button
              color="inherit"
              className={classes.AboutUsButton}
              onClick={() => scrollToDiv(props.aboutRef)}
            >
              About Us
            </Button>
            <Button
          ...
          >
            <FontAwesomeIcon className={classes.MenuIcon} icon="bars" />
          </IconButton>
          <Popper
            open={open}
