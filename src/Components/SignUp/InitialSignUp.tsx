...
const InitialSignUp: React.FC<InitialSignUpProps> = (
  ...
  const handleClick = () => {
    signUpDispatch({
      type: SignUpActionTypeEnum.SET_USER_TYPE,
      payload: value
    });
  ...
  return (
    <div className={classes.root}>
      <ActionButton className={classes.NextButton} onClick={handleClick}>
        {" "}
      ...
      <FormControl component="fieldset">
        ...
        >
          ...
          <FormControlLabel
            ...
            control={<StyledRadio />}
            label={
              <Typography className={classes.FormControlLabel}>Fan</Typography>
            }
          />
        </RadioGroup>
      </FormControl>
