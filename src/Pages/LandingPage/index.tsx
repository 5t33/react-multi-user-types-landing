      ...
      <div className={classes.LandingPageContainer}>
        ...
        <div className={classes.ContentContainer}>
          ...
          <div className={classes.JoinButtonsContainer}>
            <ActionButton className={classes.JoinButton} onClick={signUpClick} ><Typography>Create Account</Typography></ActionButton>
          </div>
            <TextChevronDownButton text="Learn More" onClick={() => scrollToDiv(aboutRef)}/>
        </div>
      </div>
    </div>
  );
